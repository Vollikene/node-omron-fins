 ...
 * @param {object} options Additional options including `MODE` `protocol` `timeoutMS` `DNA` `DA1` `DA2` `SNA` `SA1` `SA2`
...
FinsClient.prototype.init = function (port, host, options) {
    ...
    self.sequenceManager = new SequenceManager({ timeoutMS: this.timeout }, function (err, seq) {
        if (err) {
...
FinsClient.prototype.connect = function (host, port, options) {
    ...
    if(host != null || port != null || options != null) {
        ...
        if(typeof options == "object") {
            ...
            optionOverride(self.options, options, "timeoutMS");
...
/**
 * Reconnect to PLC Same as calling connect without options
 */
